...
import FrequentPage from "@/pages/FrequentPage.vue";
...
const routes = [
  ...
  },
  {
    path: '/NoticeBoard',
    name: 'NoticeBoard',
    component: () => import(/* webpackChunkName: "about" */ '../pages/NoticeBoard.vue')
  },
  {
  ...
  },
  {
    path:'/FrequentPage',
    name: 'FrequentPage',
    component: () => import(/* webpackChunkName: "about" */'../pages/FrequentPage.vue')
  },
  {
    path: '/board',
    name: "BoardList",
